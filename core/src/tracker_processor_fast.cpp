...
TrackerProcessorFast::TrackerProcessorFast(const PipelineConfig& config) : config_(config) {}

TrajectoryResult TrackerProcessorFast::Process(const ForegroundMaskResult& foreground_mask) {
    ...
    cv::Rect full_roi(0, 0, foreground_mask.candidate_mask.cols,
                      foreground_mask.candidate_mask.rows);
